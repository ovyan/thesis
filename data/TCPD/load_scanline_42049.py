...
def get_scanline_42049_data(round=1):
    ts = TimeSeries.from_json('./datasets/scanline_42049/scanline_42049.json')
    data = ts.df['Line 170'].values
    annotations = None
    with open('annotations.json') as f:
        d = json.load(f)
        annotations = d['scanline_42049']
...
if __name__ == "__main__":
    data, classes = get_scanline_42049_data()
